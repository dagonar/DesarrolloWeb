...
<body>
                    ...
                    <tr>
                        <td width="1">
                            <div style="position:absolute; width:302px; top:30px; background:url(theme/images/cn-bg.gif);">
                                <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                    <tr>
                                        <td width="1"><img src="theme/images/logo.gif" alt="" width="61" height="61" class="logo" />
                                        </td>
                            ...
                            <div id="slogan">
                                <div style="position:absolute; top:10px; left:378px; margin-left:-400px; width:681px; height:25px; font-size:25px; color:#000; font-family:'Courier New', Courier, monospace;">
                                    <marquee direction="left" width="100%" scrollamount="7">
                                        <span class="Estilo9">Bienvenido Administrador</span>
                                    </marquee>
                                </div>
                            </div>
                            <img src="theme/images/p1.jpg" alt="" width="666" height="196">
                        </td>
                        <td class="hbg">&nbsp;</td>
                    </tr>
                </table>
    ...
    <div class="titulo">
        <div align="center" class="Estilo1">Entrada a Administradores </div>
    </div>
    <br />
    <br />
    <div id="centercontent">
        <form action="mod_configuracion/login_2.php" method="post">
            <div align="center">
                <table width="200" align="center">
                    <tr>
                        <td width="70" bordercolor="#333333"><span class="Estilo10">Login:</span>
                        </td>
                        <td width="177" bordercolor="#333333">
                ...
                <table id="table-log">
                    ...
                    <tr>
                        ...
                        <td>
                            <input class="button-blue" name="submit" type="submit" value="Entrar" />
                        </td>
                        <td>
                            <input class="button-blue" name="Restablecer" type="reset" value="Limpiar" />
                        </td>
                    </tr>
                </table>
